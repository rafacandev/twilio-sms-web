...
export const toCredentials = (authentication) => {
  switch (authentication.type) {
    case AuthenticationMethod.API_KEY:
      return {username: authentication.apiKey, password: authentication.apiSecret, type: authentication.type}
    case AuthenticationMethod.AUTH_TOKEN:
      return {username: authentication.accountSid, password: authentication.authToken, type: authentication.type}
    default:
